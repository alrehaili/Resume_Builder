package com.rahimsapp.resumebuilder.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.rahimsapp.resumebuilder.service.EmailAlreadyUsedException ||
            ex instanceof com.rahimsapp.resumebuilder.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.rahimsapp.resumebuilder.service.InvalidPasswordException
